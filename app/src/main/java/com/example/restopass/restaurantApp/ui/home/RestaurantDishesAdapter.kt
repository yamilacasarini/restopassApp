...
class RestaurantDishesAdapter : RecyclerView.Adapter<DishesHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DishesHolder {
        ...
        return DishesHolder(inflater, parent)
    }
...
class DishesHolder(
    ...
    fun bind(dishesRow: Pair<String, List<Dish>>) {
        ...
        dishAdapter = DishAdapter(dishesRow.second, false, showAvailability = false)
